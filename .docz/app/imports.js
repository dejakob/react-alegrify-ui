export const imports = {
  ...
  'docs/spacing.mdx': () =>
    import(/* webpackPrefetch: true, webpackChunkName: "docs-spacing" */ 'docs/spacing.mdx'),
  'docs/status-input.mdx': () =>
    import(/* webpackPrefetch: true, webpackChunkName: "docs-status-input" */ 'docs/status-input.mdx'),
  'docs/typography.mdx': () =>
    import(/* webpackPrefetch: true, webpackChunkName: "docs-typography" */ 'docs/typography.mdx'),
}
